...
<body>	
	<ul>
		...
		<formaction="insertAction20.do?checklist_no=${detailboard.checklist_no }" method="post" >
				 <input type="hidden" name = "${detailboard.checklist_no }">
		liinfo : <input type="text" name="list_info">
				<input type="submit" value="list등록"><br><br>
		</form>
	</ul>
