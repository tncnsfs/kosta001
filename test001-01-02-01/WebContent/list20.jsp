...
<body>
	...
	<table width="500" border="1" cellpadding="0" cellspacing="0">
		<form action="insertAction20.do" method="post">
			...
			hecklist_no" value="${ls.checklist_no }">
		...
		<c:forEach var = "ls" items="${list }">
			...
			<%-- <input type="hidden" name="checklist_no" value="${ls.checklist_no }"> --%>
					<%-- <input type="hidden" name="list_no" value="${ls.list_no }"> --%>
					<a href="detail20.do?list_no=${ls.list_no}">${ls.list_info }</a>
					<%-- <a href="detail20.do?list_no=${ls.list_no }&checklist_no=${ls.checklist_no}">${ls.list_info }</a> --%>
				</td>
