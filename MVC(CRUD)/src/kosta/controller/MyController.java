...
public class MyController extends HttpServlet {
    ...
    public void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
    	...
    	// System.out.println("URI :" + requestURI); // URI�� ���� �������� ���� �۾�
    	// /MVC/insertForm.do -> insertForm.do�� �̾ƿ��� �ȴ�.
    	String contextPath = request.getContextPath(); // /MVC������
    	String command = requestURI.substring(contextPath.length()+1);
    	// System.out.println("command :" + command); // insertForm.do�� ��µ�
    	Action action = null;
    	...
    	if(command.equals("insertForm.do")){
    		...
    		try {
				forward = action.execute(request, response); //insert_form.jsp�� ����ʹٿ� �����ķ� �ϰڴٶ�� ������ ���ִ�.
			} catch (Exception e) {
				e.printStackTrace();
			}
